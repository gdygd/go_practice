...
var philosophers = []Philosopher{
	{name: "01 Plato", leftFork: 4, rightFork: 0},
	{name: "02 Socrates", leftFork: 0, rightFork: 1},
	{name: "03 Aristotle", leftFork: 1, rightFork: 2},
	{name: "04 Pascal", leftFork: 2, rightFork: 3},
	{name: "05 Locke", leftFork: 3, rightFork: 4},
}
...
func diningProblem(philosopher Philosopher, wg *sync.WaitGroup, forks map[int]*sync.Mutex, seated *sync.WaitGroup) {
	...
	mu.Lock()
	phlist = append(phlist, philosopher.name)
	mu.Unlock()
}
