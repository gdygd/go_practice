...
const file_rpc_message_proto_rawDesc = "" +
	...
	"\x18refresh_token_expires_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenExpiresAt\x12$\n" +
	"\x04user\x18\x06 \x01(\v2\x10.pb.UserResponseR\x04userB\x11Z\x0fauth-service/pbb\x06proto3"
...
var file_rpc_message_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_rpc_message_proto_depIdxs = []int32{
	3, // 0: pb.UserResponse.password_changed_at:type_name -> google.protobuf.Timestamp
	3, // 1: pb.UserResponse.created_at:type_name -> google.protobuf.Timestamp
	3, // 2: pb.LoginUserResponse.access_token_expires_at:type_name -> google.protobuf.Timestamp
	3, // 3: pb.LoginUserResponse.refresh_token_expires_at:type_name -> google.protobuf.Timestamp
	1, // 4: pb.LoginUserResponse.user:type_name -> pb.UserResponse
