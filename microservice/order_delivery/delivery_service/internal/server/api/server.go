...
func (server *Server) setupRouter() {
	...
	router.GET("/info", server.getDeliveryInfo)
	router.POST("/request", server.requestDelivery)
	router.POST("/cancel/:id", server.cancelDelivery)
	router.POST("/confirm/:id", server.confirmDelivery)
